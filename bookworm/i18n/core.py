...
class LanguageInfo:
    ...
    def description(self):
        return self.culture.DisplayName, self.culture.NativeName, self.culture.EnglishName
...
def set_active_language(language):
    ...
    try:
        translation = gettext.translation(app.name, localedir=paths.locale_path(), languages=[language,])
